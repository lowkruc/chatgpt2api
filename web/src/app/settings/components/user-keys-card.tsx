        ...
        <CardContent className="space-y-6 p-6">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-stone-500">Create dedicated keys for regular users; they can only access the drawing page, not settings or the account pool.</p>
              </div>
            </div>
          ...
          {revealedKey ? (
            <div className="rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-4 text-sm text-emerald-900">
              <div className="font-medium">The new key is shown only once; save it now:</div>
          ...
          {isLoading ? (
            ...
            <div className="rounded-xl bg-stone-50 px-6 py-10 text-center text-sm text-stone-500">
              No user keys yet. Use the button in the top-right to create one and share it with others.
            </div>
          ) : (
        ...
        <DialogContent className="rounded-2xl p-6">
          <DialogHeader className="gap-2">
            ...
            <DialogDescription className="text-sm leading-6">
              Optionally add a note to distinguish users; a raw key is generated that can only be viewed once.
            </DialogDescription>
          </DialogHeader>
      ...
      >
        <DialogContent className="rounded-2xl p-6">
          <DialogHeader className="gap-2">
            ...
            <DialogDescription className="text-sm leading-6">
              You can edit the note; to change the dedicated key, enter a new raw key. Leave empty to keep the current key.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs leading-5 text-stone-500">
                After saving, the old key is invalidated immediately and the new one takes effect. The system stores only a hash and never echoes the current key.
              </p>
            </div>
          </div>
          <DialogFooter>
