...
class ResponsesTests(unittest.TestCase):
    ...
    def test_text_response_http(self):
        """Test the non-streaming HTTP call for Responses text."""
    ...
    def test_text_response_stream_http(self):
        """Test the streaming HTTP call for Responses text."""
        response = requests.post(
            f"{BASE_URL}/v1/responses",
            headers={"Authorization": f"Bearer {AUTH_KEY}"},
            json={
    ...
    def test_image_response_http(self):
        """Test the non-streaming HTTP call for Responses image generation."""
        response = requests.post(
            f"{BASE_URL}/v1/responses",
            headers={"Authorization": f"Bearer {AUTH_KEY}"},
            json={
                ...
                "input": [
                    {
                        "role": "user",
                        "content": [
                            {"type": "input_text", "text": "I want to create a Nanjing city promotional poster."},
                        ],
                    }
                ],
    ...
    def test_image_response_stream_http(self):
        """Test the streaming HTTP call for Responses image generation."""
        response = requests.post(
            f"{BASE_URL}/v1/responses",
            headers={"Authorization": f"Bearer {AUTH_KEY}"},
            json={
    ...
    def test_codex_image_response_http(self):
        """Test the non-streaming HTTP call for Responses codex image generation."""
        response = requests.post(
            f"{BASE_URL}/v1/responses",
            headers={"Authorization": f"Bearer {AUTH_KEY}"},
            json={
    ...
    def test_codex_image_response_stream_http(self):
        """Test the streaming HTTP call for Responses codex image generation."""
        response = requests.post(
            f"{BASE_URL}/v1/responses",
            headers={"Authorization": f"Bearer {AUTH_KEY}"},
            json={
