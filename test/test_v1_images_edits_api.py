...
class ImagesEditsApiTests(unittest.TestCase):
    ...
    def test_edit_accepts_json_image_url(self):
        """Test that the image-edit API supports official JSON image_url references."""
    ...
    def test_edit_rejects_file_id_reference(self):
        """Test that the image-edit API returns a clear error for the not-yet-supported file_id."""
        response = self.client.post(
            "/v1/images/edits",
            headers=AUTH_HEADERS,
            json={
